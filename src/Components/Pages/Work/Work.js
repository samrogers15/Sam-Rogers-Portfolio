      ...
      <Container fluid className="work">
        ...
        <Col lg={6} className="workCol">
            <WorkCard
              ...
              skills="Core project responsibilities included application wireframe and design, authentication and database integration, messaging functionality, Ticketmaster and Twitter API integration, and overall application debugging."
              link="https://www.showmyshow.org/"
          ...
          <Col lg={6} className="workCol">
            <WorkCard
              ...
              skills="Core project responsibilities included application wireframe and design, authentication and database integration, search functionality, routing, and overall application debugging."
              link="https://my-favorite-recipes-app-portla.herokuapp.com/"
              github="https://github.com/jinxdoll/my-favorite-recipes-app"
            />
          </Col>
          <Col lg={6} className="workCol">
            <WorkCard
              ...
              skills="Core project responsibilities included application wireframe and design, API integration, search functionality, design, and overall application debugging."
              link="https://samrogers15.github.io/Interactive_Entertainment_Planner/"
              github="https://github.com/samrogers15/Interactive_Entertainment_Planner"
            />
          </Col>
          <Col lg={6} className="workCol">
            <WorkCard
              ...
              skills="Core project responsibilities include JavaScript, Node, NPM Inquirer, NPM MySQL, NPM console.table, and MySQL Workbench."
              link="https://drive.google.com/file/d/1_20AT6cerIgXbkMycODh86IQtiO5k_qQ/view"
              github="https://github.com/samrogers15/MySQL-employee-tracker"
            />
          </Col>
        </Row>
      </Container>
